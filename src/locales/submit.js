  ...
  'zh-CN': {
    submit: {
      ...
      editor: {
        ...
        captionLangHint: '这一批都按这个语言存。轴伊之后会自己补另外两种。',
        remove: '去掉这一条',
        notAdded: '这些文件没有加进来：',
        durability:
      ...
      field: {
        ...
        groupNew: '提一个新分组',
        newGroup: '新分组的名字',
        newGroupHint: '这是个建议 —— 建不建、叫什么，最后由轴伊定。',
        note: '给审核的留言',
        optional: '可不填',
        counter: '{n} / {max}',
        required: '要填',
        chooseGroup: '请选一个分组，或者提一个新的',
        groupsUnavailable: '现有分组的名单没读到，所以现在只能提新分组。轴伊审核的时候会归位。',
      },
      ...
      result: {
        ...
        queuedNote: '收下的已经排进审核队列，轴伊看过才会上墙。',
  ...
  'en-US': {
    submit: {
      ...
      editor: {
        ...
        captionLangHint: 'The whole batch is stored under this one. Joi writes the other two herself, later.',
      ...
      field: {
        ...
        newGroupHint: 'It is a proposal. Whether it exists, and what it ends up called, is Joi to decide.',
        ...
        groupsUnavailable:
          'The list of existing groups did not load, so a new one is the only thing on offer right now. Joi files it properly at review time.',
      },
      ...
      result: {
        ...
        queuedNote: 'The ones taken are queued. They reach the wall once Joi has listened to them.',
  ...
  'ja-JP': {
    submit: {
      ...
      editor: {
        ...
        captionLangHint: 'この回はこの言語で保存します。残りの二言語は轴伊があとから書きます。',
        remove: 'この行を外す',
      ...
      field: {
        ...
        newGroup: '新しいグループの名前',
        newGroupHint: 'あくまで提案です。作るかどうかも、名前も、決めるのは轴伊です。',
        note: '審査への伝言',
        optional: '任意',
        counter: '{n} / {max}',
        required: '必須',
      ...
      result: {
        ...
        queuedNote: '受け取った分は審査待ちです。轴伊が聴いてから壁に並びます。',
